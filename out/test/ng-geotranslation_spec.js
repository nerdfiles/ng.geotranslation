(function() {
  'use strict';
  var nggeotranslation;

  require('mocha-cakes');

  nggeotranslation = require('../lib/nggeotranslation.js');
  ...
  Feature("New Feature", "In order to use cool feature", "as a new user", "I want do include this", function() {
    return Scenario("Singing", function() {
      var voice;
      voice = null;
      Given("I am a awesome singing", function() {});
      When("I sing", function() {
        return voice = nggeotranslation.awesome();
      });
      return Then("it should sound awesome", function() {
        return voice.should.eql('awesome');
      });
    });
  });
